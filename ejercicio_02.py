...
'''Este tipo de ejercicio se llama FIZZ BUZZ'''

def print_numbers(text_1, text_2) -> int:
    count = 0 # colocamos el contador en 0 para que cuente los numeros que muestre
    for number in range(1 , 101):
        if number % 3 == 0 and number % 5 == 0:
            ...
            print(number)
            count += 1
    return count # aca retornamos el numero de veces que mostramos numero
        

print(print_numbers("Fizz","Buzz")) #imprimimos las cantidad de veces que se muestra numero y el fizz, buzz
